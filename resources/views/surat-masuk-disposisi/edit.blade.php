        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <button type="button"
                    ...
                    <!-- Hidden Delete Form (outside the update form to avoid nested forms) -->
                    ...
                    <x-confirm-modal
                        ...
                        :message="'Apakah Anda yakin ingin menghapus disposisi ini? Tindakan ini tidak dapat dibatalkan.'"
                        confirmText="Hapus"
                        cancelText="Batal"
